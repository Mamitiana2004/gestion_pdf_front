...
export default function Consigne() {
    ...
    const confirmDelete = (product) => {
        let url = `${process.env.REACT_APP_API_URL}/api/consigne/delete/${product.id}`;
        fetch(url, {
            method: "DELETE"
        }).then((res) => res.json())
            .then((data) => {
    ...
    const doCreate = () => {
        ...
        let url = `${process.env.REACT_APP_API_URL}/api/consigne/create`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const doUpdate = () => {
        ...
        let url = `${process.env.REACT_APP_API_URL}/api/consigne/update`;
        fetch(url, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
        ...
        <>
            ...
            <div className={style.container}>
                <div className={style.wrapper}>
                    ...
                    <DataTable style={{ width: "100%" }} value={consigne}
